...
if(ENABLE_INTERNAL_FLATBUFFERS)
  ...
  externalproject_add(flatbuffers
                      ...
                      CMAKE_ARGS -DCMAKE_INSTALL_PREFIX=${CMAKE_BINARY_DIR}/${CORE_BUILD_DIR}
                                 ...
                                 "${EXTRA_ARGS}"
                      PATCH_COMMAND sh -c "patch -p1 < ${CORE_SOURCE_DIR}/tools/depends/native/flatbuffers-native/0001-Fix-compiler-warning.patch && sed -i 's/-Werror/-Wno-error/g' CMakeLists.txt"
