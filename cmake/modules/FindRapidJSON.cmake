...
if(ENABLE_INTERNAL_RapidJSON)
  ...
  externalproject_add(rapidjson
                      ...
                      CONFIGURE_COMMAND ""
                      BUILD_COMMAND ""
                      INSTALL_COMMAND ${CMAKE_COMMAND} -E make_directory ${RapidJSON_INCLUDE_DIR}/rapidjson
                                      COMMAND ${CMAKE_COMMAND} -E copy_directory
                                              <SOURCE_DIR>/include/rapidjson
                                              ${RapidJSON_INCLUDE_DIR}/rapidjson
                      BUILD_BYPRODUCTS ${RapidJSON_INCLUDE_DIR}/rapidjson/rapidjson.h)
